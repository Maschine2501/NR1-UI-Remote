...
def load_font(filename, font_size):
    font_path = "/home/pi/NR1-UI-Remote/fonts/" #os.path.dirname(os.path.realpath(__file__)) + '/../fonts/'
    try:
...
class Bar(Screen):
    ...
    def DrawOn(self, image, position):
        ...
        self.draw.rectangle((1, 1, self.filledPixels-2 , self.barHeight-2), fill=(0, 255, 0))
        image.paste(self.image, position)
